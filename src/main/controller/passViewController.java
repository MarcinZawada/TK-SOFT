...
public class passViewController implements Initializable{
    private Main main;
    private DbConnector db;

    @FXML
    private TableView<Password> passTable;
    @FXML
    TableColumn<Password,String> LoginColumn;
    @FXML
    TableColumn<Password,String> PasswordColumn;
    @FXML
